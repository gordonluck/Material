    ...
    foreach($new_meta_boxes as $meta_box) {   
        ...
        switch ( $meta_box['type'] ){  
			...
			case 'uploader':   
				...
				wp_enqueue_script('kriesi_custom_fields_js', get_template_directory_uri(). '/public/css//metaup.js');  
				 wp_enqueue_style( 'meta_box_css', get_stylesheet_directory_uri().'/public/css/metabox.css'); 
                break;  
